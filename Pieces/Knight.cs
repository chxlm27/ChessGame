...
namespace Chess
{
    ...
    {
        private static readonly Rectangle WhiteKnightRect = new Rectangle(180, 0, 64, 64);
        private static readonly Rectangle BlackKnightRect = new Rectangle(180, 59, 64, 64);
